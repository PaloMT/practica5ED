...
public class GrafoMA {
    private final int numVertices;          // Número de vértices.
    private final boolean dirigido;         // indica si el grafo es dirigido o no dirigido
    private final boolean[][] matrizAdy;    // Matriz de adyacencias del grafo.
